...
parser = argparse.ArgumentParser(
    description="Run operations from the yaml config file: " + ", ".join(OPERATIONS_DICT.keys())
)
parser.add_argument(
    "-y",
    "--yamlconfig",
...
for op_data in config_data["operations"]:
    ...
    output = OPERATIONS_DICT[op_type](config=config, warehouse=warehouse, project_dir=project_dir)
