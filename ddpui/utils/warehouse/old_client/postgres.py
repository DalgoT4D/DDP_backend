...
class PostgresClient(WarehouseInterface):
    ...
    def get_connection(conn_info):
        ...
        if "sslmode" in conn_info:
            ...
            if isinstance(conn_info["sslmode"], str):
                ...
                connect_params["sslmode"] = "require" if conn_info["sslmode"] else "disable"
            elif isinstance(conn_info["sslmode"], dict) and "mode" in conn_info["sslmode"]:
    ...
    def get_total_rows(self, schema: str, table: str) -> int:
        ...
        try:
            ...
            logger.error(f"Table not found {schema}.{table}: {e}")
