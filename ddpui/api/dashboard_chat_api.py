...
def _build_dashboard_system_prompt(
    ...
    prompt_parts = [
        ...
        "🚫 CRITICAL: Use existing intelligence layers to automatically execute queries when needed",
        "🚫 CRITICAL: If data needs aggregation, calculate it directly from available data",
        "",
