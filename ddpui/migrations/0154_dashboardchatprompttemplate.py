# Generated by Django 4.2 on 2026-03-21 10:44

from django.db import migrations, models
import django.utils.timezone


def seed_dashboard_chat_prompt_templates(apps, schema_editor):
    DashboardChatPromptTemplate = apps.get_model("ddpui", "DashboardChatPromptTemplate")

    defaults = {
        "intent_classification": """# Enhanced Intent Classification System Prompt
...
Classify the following user query:""",
        "new_query_system": """You are a data analysis assistant with access to tools. Your job is to help users understand program data and answer their questions accurately.
...
7. ALWAYS call run_sql_query with validated SQL - NEVER give up without trying""",
        "follow_up_system": """You are handling a follow-up query that modifies a previous question.
...
class Migration(migrations.Migration):
    dependencies = [
        ("ddpui", "0153_alter_dashboardchatmessage_created_at_and_more"),
    ]
    ...
    operations = [
        ...
        migrations.RunPython(
            seed_dashboard_chat_prompt_templates,
