...
#     def test_create_serverblock(self):
...
#     def test_fetch_serverblock(self):
...
#     def test_delete_serverblock(self):
#         """cleans up"""
...
#     def test_create_connectionblock(self):
...
#     def test_get_connectionblockid(self):
...
#     def test_create_shellblock(self):
...
#     def test_delete_shell_block(self):
