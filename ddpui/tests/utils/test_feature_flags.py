...
class TestFeatureFlags(TestCase):
    ...
    def test_ai_dashboard_chat_flag_is_available(self):
        """Test the dashboard chat feature flag can be enabled and listed."""
        enable_feature_flag("AI_DASHBOARD_CHAT", org=self.org)
