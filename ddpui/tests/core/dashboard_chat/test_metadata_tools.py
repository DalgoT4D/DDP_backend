    ...
    return DashboardChatMetadataArtifactPayload(
        ...
        tables=[
            DashboardChatMetadataTable(
                ...
                row_grain="One row per student assessment",
                table_type="fact",
                primary_entities=["student"],
                candidate_unique_id_columns=["student_id"],
                preferred_use_cases=["score thresholds", "student rankings"],
                columns=[
                    DashboardChatMetadataColumn(
                        name="student_id",
                        data_type="integer",
                        ...
                        entity_tags=["student"],
                        aggregation_hints=["count_distinct"],
                    ),
                    DashboardChatMetadataColumn(
                        ...
                        entity_tags=["student"],
                        measure_tags=["math", "mastery", "endline"],
                        aggregation_hints=["avg", "sum"],
                    ),
                ],
            ),
            DashboardChatMetadataTable(
                ...
                row_grain="One row per student",
                table_type="dim",
                primary_entities=["student"],
                candidate_unique_id_columns=["student_id"],
                preferred_use_cases=["name lists"],
                columns=[
                    DashboardChatMetadataColumn(
                        name="student_id",
                        data_type="integer",
                    ...
                    DashboardChatMetadataColumn(
                        name="student_name_end",
                        data_type="text",
                        semantic_role="label",
                        entity_tags=["student"],
                        aggregation_hints=["group_by"],
                    ),
                ],
            ),
        ],
