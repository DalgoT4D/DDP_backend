...
class TestFetchComments:
    ...
    def test_returns_summary_comments(self, snapshot, orguser, org):
    ...
    def test_returns_chart_comments_filtered_by_chart_id(self, snapshot, orguser, org):
        Comment.objects.create(
    ...
    def test_returns_chronological_order(self, snapshot, orguser, org):
    ...
    def test_does_not_return_other_target_types(self, snapshot, orguser, org):
        Comment.objects.create(
            target_type=CommentTargetType.SUMMARY,
            snapshot=snapshot,
            content="Summary",
...
class TestAnnotateIsNew:
    ...
    def test_all_new_when_no_read_status(self, snapshot, orguser, other_orguser, org):
    ...
    def test_own_comments_never_new(self, snapshot, orguser, org):
        ...
        CommentService._annotate_is_new(
            [comment], snapshot, CommentTargetType.SUMMARY, None, orguser
        )
        assert comment.is_new is False

    def test_comments_before_read_cursor_are_not_new(self, snapshot, orguser, other_orguser, org):
    ...
    def test_comments_after_read_cursor_are_new(self, snapshot, orguser, other_orguser, org):
    ...
    def test_no_orguser_marks_all_new(self, snapshot, orguser, org):
    ...
    def test_chart_read_status_uses_chart_id(self, snapshot, orguser, other_orguser, org):
...
class TestGetCommentStates:
    ...
    def test_returns_list(self, snapshot, orguser, other_orguser, org):
    ...
    def test_summary_entry_has_correct_fields(self, snapshot, orguser, other_orguser, org):
    ...
    def test_chart_entry_has_correct_fields(self, snapshot, orguser, other_orguser, org):
    ...
    def test_mixed_targets_returns_multiple_entries(self, snapshot, orguser, other_orguser, org):
    ...
    def test_unread_state_for_never_read(self, snapshot, orguser, other_orguser, org):
    ...
    def test_read_state_after_mark_as_read(self, snapshot, orguser, other_orguser, org):
    ...
    def test_mentioned_state(self, snapshot, orguser, other_orguser, org):
    ...
    def test_edited_comment_stays_read(self, snapshot, orguser, other_orguser, org):
    ...
    def test_deleted_comments_excluded(self, snapshot, orguser, other_orguser, org):
    ...
    def test_read_status_does_not_cross_targets(self, snapshot, orguser, other_orguser, org):
...
class TestCreateComment:
    ...
    def test_invalid_target_type_raises(self, snapshot, orguser, org):
...
class TestListComments:
    ...
    def test_returns_comments_with_is_new(self, mock_send, snapshot, orguser, other_orguser, org):
        Comment.objects.create(
            target_type=CommentTargetType.SUMMARY,
            snapshot=snapshot,
            content=f"Hey @{other_orguser.user.email}",
