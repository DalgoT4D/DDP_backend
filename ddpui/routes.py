...
from ddpui.api.chat_with_data_api import chat_with_data_router
...
chat_with_data_router.tags = ["Chat with Data"]
...
src_api.add_router("/api/chat-with-data/", chat_with_data_router)
