...
def build_tool_document_payload(
    ...
    metadata: dict[str, Any] = {
        "type": tool_document_type(document.source_type),
        "source_type": document.source_type,
        "source_identifier": document.source_identifier,
    }
    chart_id = chart_id_from_source_identifier(document.source_identifier)
...
def tool_document_type(source_type: str) -> str:
    """Map dashboard-chat source types into the tool payload doc-type vocabulary."""
