"""Handle-follow-up node for dashboard chat graph (covers follow_up_sql and follow_up_context)."""

from typing import Any

from ddpui.core.dashboard_chat.contracts import DashboardChatResponse

from ddpui.core.dashboard_chat.orchestration.message_stack import build_follow_up_messages
...
def handle_follow_up_node(
    ...
    """Execute the follow-up tool loop for SQL-modifying and explanatory follow-up questions."""
