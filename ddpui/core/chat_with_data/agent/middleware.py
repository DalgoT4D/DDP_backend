"""Agent middleware: dynamic system prompt, history trimming, SQL-retry limiter.

These are the three sanctioned customization points of the prebuilt agent loop —
the graph topology itself is never modified.
"""
